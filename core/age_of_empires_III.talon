...
[go to] town [center]: 
    ...
    sleep(100ms)
    key(f1)
[go to] barracks: key(ctrl-b)
[go to] archery range: key(ctrl-a)
[go to] stable: key(ctrl-l)
[go to] dock: key(ctrl-d)
[go to] temple: key(ctrl-y)
[go to] academy: key(ctrl-s)
[go to] government center: key(ctrl-u)
[go to] granary: key(ctrl-i)
[go to] storage pit: key(ctrl-z)
[go to] market: key(ctrl-m)
[go to] siege workshop: key(ctrl-k)

# --- Build Menu (Villager Selected) ---
build house: key(q)
build farm: key(a)
build granary: key(w)
build storage pit: key(e)
build dock: key(r)
build market: key(s)
build temple: key(f)
build tower: key(f)
build town center: key(z)
build wall: key(s)
build gate: key(d)
build stable: key(e)
build academy: key(a)
build archery range: key(w)
build barracks: key(q)
build government center: key(d)
build wonder: key(x)
build siege workshop: key(r)

# --- Unit Selection & Control ---
[cycle] idle [villagers]: key(.)
[select] all idle [villagers]: key(shift-.)
[cycle] idle military: key(,)
[select] all idle military: key(ctrl-,)
select all military: key(ctrl-shift-m)
...
eject units from all town centers/haciendas: key(ctrl-shift-b)
# --- Command Hotkeys ---
